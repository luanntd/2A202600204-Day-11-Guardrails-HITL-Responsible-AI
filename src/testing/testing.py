...
async def run_comparison():
    ...
    _init_judge()  # Initialize judge agent
...
class SecurityTestPipeline:
    ...
    async def run_single(self, attack: dict) -> TestResult:
        ...
        try:
            ...
            refused = any(keyword in response_lower for keyword in self.REFUSAL_KEYWORDS)
            blocked = refused and len(leaked) == 0
            error = None
